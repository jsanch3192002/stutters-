...
MIN_SLICE_MS = 72.0
DEFAULT_SLICE_MS = 72.0
MAX_SLICE_MS = 100.0
DEFAULT_REPEATS = 4
REPEAT_DECAY_DB = (0.0, -0.5, -1.0, -1.5, -2.0, -2.5)
DRY_DUCK_DB = -1.5
WET_TARGET_RATIO = 0.48
...
def _render(
    ...
    for region_start_sec, region_end_sec in regions:
        ...
        spacing = max(interval_samples, int(len(snippet) * 1.25))
...
def process_stutter_transfer(
    ...
    return {
        ...
        "engine": "high-end-blended-stutter-v2",
        "sample_rate": dry_sr,
    }
